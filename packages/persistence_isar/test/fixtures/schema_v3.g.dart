...
extension GetSearchProjectionRecordCollection on Isar {
  IsarCollection<SearchProjectionRecord> get searchProjectionRecords =>
      this.collection();
}

const SearchProjectionRecordSchema = CollectionSchema(
  name: r'SearchProjectionRecord',
  id: 6094677479976271722,
  properties: {
  ...
  estimateSize: _searchProjectionRecordEstimateSize,
  serialize: _searchProjectionRecordSerialize,
  deserialize: _searchProjectionRecordDeserialize,
  deserializeProp: _searchProjectionRecordDeserializeProp,
  idName: r'id',
  indexes: {
    r'documentId': IndexSchema(
      id: 4187168439921340405,
  ...
  getId: _searchProjectionRecordGetId,
  getLinks: _searchProjectionRecordGetLinks,
  attach: _searchProjectionRecordAttach,
  version: '3.3.2',
);

int _searchProjectionRecordEstimateSize(
  SearchProjectionRecord object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _searchProjectionRecordSerialize(
  SearchProjectionRecord object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
SearchProjectionRecord _searchProjectionRecordDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = SearchProjectionRecord();
...
P _searchProjectionRecordDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _searchProjectionRecordGetId(SearchProjectionRecord object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _searchProjectionRecordGetLinks(
  SearchProjectionRecord object,
) {
  return [];
}

void _searchProjectionRecordAttach(
  IsarCollection<dynamic> col,
  Id id,
  SearchProjectionRecord object,
) {
...
extension SearchProjectionRecordByIndex
    on IsarCollection<SearchProjectionRecord> {
  Future<SearchProjectionRecord?> getByDocumentId(String documentId) {
    return getByIndex(r'documentId', [documentId]);
  }

  SearchProjectionRecord? getByDocumentIdSync(String documentId) {
    return getByIndexSync(r'documentId', [documentId]);
  }
  ...
  Future<List<SearchProjectionRecord?>> getAllByDocumentId(
    List<String> documentIdValues,
  ) {
    final values = documentIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'documentId', values);
  ...
  List<SearchProjectionRecord?> getAllByDocumentIdSync(
    List<String> documentIdValues,
  ) {
    final values = documentIdValues.map((e) => [e]).toList();
    return getAllByIndexSync(r'documentId', values);
  ...
  Future<Id> putByDocumentId(SearchProjectionRecord object) {
    return putByIndex(r'documentId', object);
  }

  Id putByDocumentIdSync(
    SearchProjectionRecord object, {
    bool saveLinks = true,
  }) {
    return putByIndexSync(r'documentId', object, saveLinks: saveLinks);
  ...
  Future<List<Id>> putAllByDocumentId(List<SearchProjectionRecord> objects) {
    return putAllByIndex(r'documentId', objects);
  }

  List<Id> putAllByDocumentIdSync(
    List<SearchProjectionRecord> objects, {
    bool saveLinks = true,
  }) {
    return putAllByIndexSync(r'documentId', objects, saveLinks: saveLinks);
  }
...
extension SearchProjectionRecordQueryWhereSort
    on QueryBuilder<SearchProjectionRecord, SearchProjectionRecord, QWhere> {
  QueryBuilder<SearchProjectionRecord, SearchProjectionRecord, QAfterWhere>
  anyId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IdWhereClause.any());
    });
...
extension SearchProjectionRecordQueryWhere
    on
        QueryBuilder<
...
extension SearchProjectionRecordQueryFilter
    on
        QueryBuilder<
          SearchProjectionRecord,
          SearchProjectionRecord,
...
extension SearchProjectionRecordQueryObject
    on
        QueryBuilder<
          SearchProjectionRecord,
          SearchProjectionRecord,
...
extension SearchProjectionRecordQueryLinks
    on
        QueryBuilder<
          SearchProjectionRecord,
          SearchProjectionRecord,
...
extension SearchProjectionRecordQuerySortBy
    on QueryBuilder<SearchProjectionRecord, SearchProjectionRecord, QSortBy> {
  QueryBuilder<SearchProjectionRecord, SearchProjectionRecord, QAfterSortBy>
  sortByContent() {
    return QueryBuilder.apply(this, (query) {
...
extension SearchProjectionRecordQuerySortThenBy
    on
        QueryBuilder<
          SearchProjectionRecord,
          SearchProjectionRecord,
...
extension SearchProjectionRecordQueryWhereDistinct
    on QueryBuilder<SearchProjectionRecord, SearchProjectionRecord, QDistinct> {
  QueryBuilder<SearchProjectionRecord, SearchProjectionRecord, QDistinct>
...
extension SearchProjectionRecordQueryProperty
    on
        QueryBuilder<
          SearchProjectionRecord,
          SearchProjectionRecord,
          QQueryProperty
        > {
  QueryBuilder<SearchProjectionRecord, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<SearchProjectionRecord, String, QQueryOperations>
  contentProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SearchProjectionRecord, int, QQueryOperations>
  revisionProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'revision');
    });
...
void _attachmentRecordSerialize(
  ...
  writer.writeString(offsets[10], object.workspaceId);
}
...
AttachmentRecord _attachmentRecordDeserialize(
  ...
  object.workspaceId = reader.readString(offsets[10]);
  return object;
}
...
extension AttachmentRecordByIndex on IsarCollection<AttachmentRecord> {
  Future<AttachmentRecord?> getByAttachmentId(String attachmentId) {
    return getByIndex(r'attachmentId', [attachmentId]);
  }

  AttachmentRecord? getByAttachmentIdSync(String attachmentId) {
    return getByIndexSync(r'attachmentId', [attachmentId]);
  }

  Future<bool> deleteByAttachmentId(String attachmentId) {
    return deleteByIndex(r'attachmentId', [attachmentId]);
  }

  bool deleteByAttachmentIdSync(String attachmentId) {
    return deleteByIndexSync(r'attachmentId', [attachmentId]);
  }

  Future<List<AttachmentRecord?>> getAllByAttachmentId(
    List<String> attachmentIdValues,
  ) {
    final values = attachmentIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'attachmentId', values);
  }

  List<AttachmentRecord?> getAllByAttachmentIdSync(
    List<String> attachmentIdValues,
  ) {
    final values = attachmentIdValues.map((e) => [e]).toList();
    return getAllByIndexSync(r'attachmentId', values);
  }

  Future<int> deleteAllByAttachmentId(List<String> attachmentIdValues) {
    final values = attachmentIdValues.map((e) => [e]).toList();
    return deleteAllByIndex(r'attachmentId', values);
  }

  int deleteAllByAttachmentIdSync(List<String> attachmentIdValues) {
    final values = attachmentIdValues.map((e) => [e]).toList();
    return deleteAllByIndexSync(r'attachmentId', values);
  }

  Future<Id> putByAttachmentId(AttachmentRecord object) {
    return putByIndex(r'attachmentId', object);
  }

  Id putByAttachmentIdSync(AttachmentRecord object, {bool saveLinks = true}) {
    return putByIndexSync(r'attachmentId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByAttachmentId(List<AttachmentRecord> objects) {
    return putAllByIndex(r'attachmentId', objects);
  }

  List<Id> putAllByAttachmentIdSync(
    List<AttachmentRecord> objects, {
    bool saveLinks = true,
  }) {
    return putAllByIndexSync(r'attachmentId', objects, saveLinks: saveLinks);
  }
}
...
extension AttachmentRecordQuerySortBy
  ...
  QueryBuilder<AttachmentRecord, AttachmentRecord, QAfterSortBy> sortBySize() {
    return QueryBuilder.apply(this, (query) {
...
extension AttachmentRecordQuerySortThenBy
  ...
  QueryBuilder<AttachmentRecord, AttachmentRecord, QAfterSortBy> thenBySize() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'size', Sort.asc);
    });
  }
...
extension AttachmentRecordQueryWhereDistinct
  ...
  QueryBuilder<AttachmentRecord, AttachmentRecord, QDistinct> distinctBySize() {
    return QueryBuilder.apply(this, (query) {
...
extension AttachmentRecordQueryProperty
  ...
  QueryBuilder<AttachmentRecord, String, QQueryOperations> fileNameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'fileName');
    });
  }

  QueryBuilder<AttachmentRecord, bool, QQueryOperations> isDeletedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isDeleted');
    });
  }

  QueryBuilder<AttachmentRecord, String, QQueryOperations> mediaTypeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'mediaType');
    });
  }

  QueryBuilder<AttachmentRecord, int, QQueryOperations> revisionProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'revision');
    });
  }
  ...
  QueryBuilder<AttachmentRecord, int, QQueryOperations> sizeProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension GetAttachmentCommitRecordCollection on Isar {
  IsarCollection<AttachmentCommitRecord> get attachmentCommitRecords =>
      this.collection();
}

const AttachmentCommitRecordSchema = CollectionSchema(
  name: r'AttachmentCommitRecord',
  id: 3822409553350460561,
  properties: {
    r'attachmentId': PropertySchema(
      id: 0,
      name: r'attachmentId',
    ...
    r'sha256': PropertySchema(id: 2, name: r'sha256', type: IsarType.string),
    r'size': PropertySchema(id: 3, name: r'size', type: IsarType.long),
    r'stagingToken': PropertySchema(
      id: 4,
      name: r'stagingToken',
      type: IsarType.string,
    ),
  ...
  estimateSize: _attachmentCommitRecordEstimateSize,
  serialize: _attachmentCommitRecordSerialize,
  deserialize: _attachmentCommitRecordDeserialize,
  deserializeProp: _attachmentCommitRecordDeserializeProp,
  idName: r'id',
  indexes: {
    r'attachmentId': IndexSchema(
      id: 5677012331559006036,
  ...
  getId: _attachmentCommitRecordGetId,
  getLinks: _attachmentCommitRecordGetLinks,
  attach: _attachmentCommitRecordAttach,
  version: '3.3.2',
);

int _attachmentCommitRecordEstimateSize(
  AttachmentCommitRecord object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
  bytesCount += 3 + object.attachmentId.length * 3;
  bytesCount += 3 + object.sha256.length * 3;
  bytesCount += 3 + object.stagingToken.length * 3;
  return bytesCount;
}

void _attachmentCommitRecordSerialize(
  AttachmentCommitRecord object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
  ...
  writer.writeString(offsets[0], object.attachmentId);
  writer.writeDateTime(offsets[1], object.createdAt);
  writer.writeString(offsets[2], object.sha256);
  writer.writeLong(offsets[3], object.size);
  writer.writeString(offsets[4], object.stagingToken);
}

AttachmentCommitRecord _attachmentCommitRecordDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = AttachmentCommitRecord();
  object.attachmentId = reader.readString(offsets[0]);
  object.createdAt = reader.readDateTime(offsets[1]);
  object.id = id;
  object.sha256 = reader.readString(offsets[2]);
  object.size = reader.readLong(offsets[3]);
  object.stagingToken = reader.readString(offsets[4]);
  return object;
}

P _attachmentCommitRecordDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _attachmentCommitRecordGetId(AttachmentCommitRecord object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _attachmentCommitRecordGetLinks(
  AttachmentCommitRecord object,
) {
  return [];
}

void _attachmentCommitRecordAttach(
  IsarCollection<dynamic> col,
  Id id,
  AttachmentCommitRecord object,
) {
...
extension AttachmentCommitRecordByIndex
    on IsarCollection<AttachmentCommitRecord> {
  Future<AttachmentCommitRecord?> getByAttachmentId(String attachmentId) {
    return getByIndex(r'attachmentId', [attachmentId]);
  }

  AttachmentCommitRecord? getByAttachmentIdSync(String attachmentId) {
    return getByIndexSync(r'attachmentId', [attachmentId]);
  }
  ...
  Future<List<AttachmentCommitRecord?>> getAllByAttachmentId(
    List<String> attachmentIdValues,
  ) {
    final values = attachmentIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'attachmentId', values);
  ...
  List<AttachmentCommitRecord?> getAllByAttachmentIdSync(
    List<String> attachmentIdValues,
  ) {
    final values = attachmentIdValues.map((e) => [e]).toList();
    return getAllByIndexSync(r'attachmentId', values);
  ...
  Future<Id> putByAttachmentId(AttachmentCommitRecord object) {
    return putByIndex(r'attachmentId', object);
  }

  Id putByAttachmentIdSync(
    AttachmentCommitRecord object, {
    bool saveLinks = true,
  }) {
    return putByIndexSync(r'attachmentId', object, saveLinks: saveLinks);
  ...
  Future<List<Id>> putAllByAttachmentId(List<AttachmentCommitRecord> objects) {
    return putAllByIndex(r'attachmentId', objects);
  }

  List<Id> putAllByAttachmentIdSync(
    List<AttachmentCommitRecord> objects, {
    bool saveLinks = true,
  }) {
    return putAllByIndexSync(r'attachmentId', objects, saveLinks: saveLinks);
  }
...
extension AttachmentCommitRecordQueryWhereSort
    on QueryBuilder<AttachmentCommitRecord, AttachmentCommitRecord, QWhere> {
  QueryBuilder<AttachmentCommitRecord, AttachmentCommitRecord, QAfterWhere>
  anyId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IdWhereClause.any());
    });
...
extension AttachmentCommitRecordQueryWhere
    on
        QueryBuilder<
...
extension AttachmentCommitRecordQueryFilter
    on
        QueryBuilder<
          AttachmentCommitRecord,
          AttachmentCommitRecord,
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  stagingTokenEqualTo(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
          property: r'stagingToken',
          value: value,
          caseSensitive: caseSensitive,
        ),
      );
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  stagingTokenStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.startsWith(
          property: r'stagingToken',
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  stagingTokenEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.endsWith(
          property: r'stagingToken',
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  stagingTokenContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.contains(
          property: r'stagingToken',
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  stagingTokenMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.matches(
          property: r'stagingToken',
  ...
  stagingTokenIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'stagingToken', value: ''),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  stagingTokenIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'stagingToken', value: ''),
      );
    });
  }
}

extension AttachmentCommitRecordQueryObject
    on
        QueryBuilder<
          AttachmentCommitRecord,
          AttachmentCommitRecord,
...
extension AttachmentCommitRecordQueryLinks
    on
        QueryBuilder<
          AttachmentCommitRecord,
          AttachmentCommitRecord,
...
extension AttachmentCommitRecordQuerySortBy
    on QueryBuilder<AttachmentCommitRecord, AttachmentCommitRecord, QSortBy> {
  QueryBuilder<AttachmentCommitRecord, AttachmentCommitRecord, QAfterSortBy>
  sortByAttachmentId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'attachmentId', Sort.asc);
    });
  ...
  sortByStagingToken() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'stagingToken', Sort.asc);
    });
  }

  QueryBuilder<AttachmentCommitRecord, AttachmentCommitRecord, QAfterSortBy>
  sortByStagingTokenDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'stagingToken', Sort.desc);
    });
  }
}

extension AttachmentCommitRecordQuerySortThenBy
    on
        QueryBuilder<
          AttachmentCommitRecord,
          AttachmentCommitRecord,
...
extension AttachmentCommitRecordQueryWhereDistinct
    on QueryBuilder<AttachmentCommitRecord, AttachmentCommitRecord, QDistinct> {
  QueryBuilder<AttachmentCommitRecord, AttachmentCommitRecord, QDistinct>
  distinctByAttachmentId({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'attachmentId', caseSensitive: caseSensitive);
    });
  ...
  QueryBuilder<AttachmentCommitRecord, AttachmentCommitRecord, QDistinct>
  distinctByStagingToken({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'stagingToken', caseSensitive: caseSensitive);
    });
  }
}

extension AttachmentCommitRecordQueryProperty
    on
        QueryBuilder<
          AttachmentCommitRecord,
          AttachmentCommitRecord,
          QQueryProperty
        > {
  QueryBuilder<AttachmentCommitRecord, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<AttachmentCommitRecord, String, QQueryOperations>
  attachmentIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'attachmentId');
    });
  ...
  QueryBuilder<AttachmentCommitRecord, DateTime, QQueryOperations>
  createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'createdAt');
    });
  ...
  QueryBuilder<AttachmentCommitRecord, int, QQueryOperations> sizeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'size');
    });
  }
  ...
  QueryBuilder<AttachmentCommitRecord, String, QQueryOperations>
  stagingTokenProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'stagingToken');
    });
  }
}
...
const RuntimeStateRecordSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'searchIndexedSequence': PropertySchema(
      id: 1,
      name: r'searchIndexedSequence',
      type: IsarType.long,
    ),
  },
...
void _runtimeStateRecordSerialize(
  ...
  writer.writeLong(offsets[1], object.searchIndexedSequence);
}
...
RuntimeStateRecord _runtimeStateRecordDeserialize(
  ...
  object.id = id;
  object.searchIndexedSequence = reader.readLong(offsets[1]);
  return object;
}
...
extension RuntimeStateRecordQueryFilter
  ...
  QueryBuilder<RuntimeStateRecord, RuntimeStateRecord, QAfterFilterCondition>
  searchIndexedSequenceEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
          property: r'searchIndexedSequence',
          value: value,
        ),
      );
    });
  ...
  QueryBuilder<RuntimeStateRecord, RuntimeStateRecord, QAfterFilterCondition>
  searchIndexedSequenceGreaterThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
  ...
  QueryBuilder<RuntimeStateRecord, RuntimeStateRecord, QAfterFilterCondition>
  searchIndexedSequenceLessThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
...
extension RuntimeStateRecordQuerySortBy
  ...
  QueryBuilder<RuntimeStateRecord, RuntimeStateRecord, QAfterSortBy>
  sortBySearchIndexedSequence() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'searchIndexedSequence', Sort.asc);
    });
  }

  QueryBuilder<RuntimeStateRecord, RuntimeStateRecord, QAfterSortBy>
  sortBySearchIndexedSequenceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'searchIndexedSequence', Sort.desc);
    });
  }
}
...
extension RuntimeStateRecordQuerySortThenBy
  ...
  QueryBuilder<RuntimeStateRecord, RuntimeStateRecord, QAfterSortBy>
  thenBySearchIndexedSequenceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'searchIndexedSequence', Sort.desc);
    });
  }
...
extension RuntimeStateRecordQueryWhereDistinct
  ...
  QueryBuilder<RuntimeStateRecord, RuntimeStateRecord, QDistinct>
  distinctBySearchIndexedSequence() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'searchIndexedSequence');
    });
  }
}
...
extension RuntimeStateRecordQueryProperty
  ...
  QueryBuilder<RuntimeStateRecord, int, QQueryOperations>
  searchIndexedSequenceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'searchIndexedSequence');
    });
  }
}
